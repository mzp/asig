...
(* OASIS_START *)
(* DO NOT EDIT (digest: bfac4bf06ab3de3be54378507f5c477f) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Version"; "AsakusaSatellite"; "Irc"; "Base"];
                      lib_pack = true;
                      lib_internal_modules =
                        ["Http"; "WebSocket"; "JsonUtil"; "ElMonad"];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "src";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "asig"];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "camlp4"];
                      bs_c_sources = [];
                      bs_data_files = [];
     ...
     oasis_version = "0.4.2";
     oasis_digest =
       Some "\193\200\142*\240\138\243\166\209A\145\245\216\227\211e";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
